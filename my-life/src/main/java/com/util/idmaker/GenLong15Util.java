...
public class GenLong15Util {
    ...
    public static Long timeStamp2Id(Long secondTimeStamp) {
        String differ = String.valueOf(secondTimeStamp - GenLong15Util.EPOCH);
        return new BigInteger(differ + minNum + machineCode).longValue();
    }

    public static Long id2TimeStamp(Long id) {
        return id / 100000+ GenLong15Util.EPOCH;
    }
}
